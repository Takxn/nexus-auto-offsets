...
| Komponente | Zweck |
|------------|--------|
| **IDA Pro 9.x** | Disassembler, läuft das NEXUS+ Plugin — [IDA Pro 9.3 Download](https://hex-rays.com/ida-pro) |
...
IDA Pro 9.3 (als .7z) herunterladen: [IDA Pro 9.3 Download](https://hex-rays.com/ida-pro) — entpacken und IDA aus dem entpackten Ordner starten.
